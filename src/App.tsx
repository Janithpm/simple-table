...
function App() {
  ...
  const cols = [
    { header: 'Employee Name', field: 'employee_name', width: 200 },
    { header: 'ID', width: 100, field: 'emp_id' },
    { header: 'Duration', width: 200, field: 'duration' },
    {
      header: 'Leave Type', width: 200, field: 'leave_type', render: (row: any) => {
    ...
    { header: 'Manager Decision', width: 200, field: 'manager_decision', render: (row: any) => <Badge color="#2b63d2">{row.manager_decision}</Badge> }
  ]
